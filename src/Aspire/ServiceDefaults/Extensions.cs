...
// Adds common .NET Aspire services: automated ETW, metrics, and tracing with OpenTelemetry.
        ...
        builder.Services.AddOpenTelemetry()
            ...
            .WithTracing(tracing =>
            {
                tracing.AddAspNetCoreInstrumentation()
                    //  Uncomment the following line to see all internal abstract and internal calls in the trace
