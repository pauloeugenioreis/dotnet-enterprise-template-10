...
/// Used with assembly scanning tools such as FluentValidation, AutoMapper, MediatR, Scrutor, etc.
/// </summary>
/// <example>
...
/// </code>
/// AutoMapper — scans all profiles in the Domain assembly:
/// <code>
/// services.AddAutoMapper(typeof(DomainAssemblyMarker).Assembly);
/// </code>
