...
///    - Uncomment NHibernate packages in src/Server/Data/Data.csproj (lines ~31-32)
...
///    - Run: dotnet restore && dotnet run --project src/Server/Api
///
...
/// See: src/Server/Data/Repository/README.md for detailed instructions
/// ==================================================================================
///
