      ...
      <div className="w-72 bg-white shadow-2xl relative flex flex-col z-20">
        ...
        <div className="p-8 border-t border-gray-100 flex flex-col gap-6 bg-gray-50/30">
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-3 px-6 py-4 bg-white border border-red-100 text-red-500 rounded-2xl hover:bg-red-600 hover:text-white hover:border-red-600 transition-all duration-300 text-[11px] font-black uppercase tracking-widest active:scale-95 shadow-sm hover:shadow-xl hover:shadow-red-600/20 group/logout"
          >
            <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" className="group-hover/logout:translate-x-1 transition-transform">
